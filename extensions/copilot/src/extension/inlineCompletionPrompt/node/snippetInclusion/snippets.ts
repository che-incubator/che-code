 ...
 *--------------------------------------------------------------------------------------------*/
// Must be a type import due to cyclic dependencies.
import type { ScoredSnippet } from './selectRelevance';
...
export enum SnippetProviderType {
	...
	Language = 'language',
	Path = 'path',
	TooltipSignature = 'tooltip-signature',
	Trait = 'trait',
	CodeSnippet = 'code',
}
...
export type SnippetToAnnounce = Pick<SnippetWithProviderInfo, 'snippet' | 'semantics' | 'relativePath'>;
