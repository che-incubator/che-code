...
import { DocumentInfoWithOffset, SimilarFileInfo, SimilarFilesOptions } from '../../common/prompt';
...
export const DEFAULT_SNIPPET_THRESHOLD = 0.0;
export const DEFAULT_SNIPPET_WINDOW_SIZE = 60;
export const DEFAULT_MAX_TOP_SNIPPETS = 4;
export const DEFAULT_MAX_SNIPPETS_PER_FILE = 1;
export const DEFAULT_MAX_NUMBER_OF_FILES = 20;
export const DEFAULT_MAX_CHARACTERS_PER_FILE = 10000;
