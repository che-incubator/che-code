...
import { SessionLifecycle, SessionStatus, TurnState, ToolCallStatus, ToolCallConfirmationReason, createSessionState, createActiveTurn, ROOT_STATE_URI, PolicyState, ResponsePartKind, type ISessionState, type ISessionSummary, IRootState } from '../../../../../../platform/agentHost/common/state/sessionState.js';
...
class MockAgentHostService extends mock<IAgentHostService>() {
	...
	override getSubscription<T>(resource: URI): IReference<IAgentSubscription<T>> {
		const resourceStr = resource.toString();
